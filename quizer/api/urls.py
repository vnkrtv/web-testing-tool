...
urlpatterns = [
    ...
    path(
        "tests/<test_id>/questions", views.QuestionAPI.as_view(), name="questions_api"
    ),
    path(
        "tests/<test_id>/questions/<str:question_id>",
        views.QuestionAPI.as_view(),
        name="edit_questions_api",
    ),
    ...
    path(
        "analysis/questions",
        views.QuestionAnalysisAPI.as_view(),
        name="question_analysis_api",
    ),
]
