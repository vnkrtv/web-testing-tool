...
urlpatterns = [
    ...
    url(
        r"^available_tests/$",
        views.AvailableTestsView.as_view(),
    ...
    path(
        "tests_results/<test_results_id>",
        views.lecturer_current_test_results,
        name="show_test_results",
    ),
    path(
        "user_results/<int:user_id>", views.student_tests_results, name="user_results"
    ),
    ...
    url(
        r"^administration/$", views.AdministrationView.as_view(), name="administration"
    ),
